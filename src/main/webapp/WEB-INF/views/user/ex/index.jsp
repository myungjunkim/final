			...
			<ul class="rslides" id="slider">
			    <li>
						...
						<div class="banner-text">
							<h3>New Items</h3>
						<p>We all know... Furniture is science</p>
				...
				<li>
						...
						<div class="banner-text">
							<h3>Fun-iture maketh Furniture</h3>
						<p>We design, We make, We sell</p>
				...
				<li>
						<div class="banner-text">
							<h3>Only you know what you need</h3>
						<p>Make your own dream furniture with Fun-iture</p>
